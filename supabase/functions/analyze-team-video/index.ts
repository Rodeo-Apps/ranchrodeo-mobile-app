...
// analyze-team-video edge function for ranchrodeo.
//
...
const SYSTEM_PROMPT =
  "You are an expert ranchrodeo coach reviewing a roster athlete's run for a coaching team. " +
        ...
        messages: [
          { role: "system", content: SYSTEM_PROMPT + " JSON schema: " + JSON.stringify(ANALYSIS_SCHEMA) },
          {
            ...
            content: [
              {
                type: "text",
                text: `Analyze this ranchrodeo run${athlete_name ? ` by ${athlete_name}` : ""}.`,
              },
              ...images,
            ],
          },
